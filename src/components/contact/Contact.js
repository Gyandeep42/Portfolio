...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (username === '') {
      ...
      emailjs
        .send(
          'service_qhpb4t9', // replace with your EmailJS service ID
          'template_fzcur4p', // replace with your EmailJS template ID
          templateParams,
          'N8EN8q-YMd0_87_9y' // replace with your EmailJS user ID
        )
        .then(
          (response) => {
